...
public class AsteroidSplitterImpl implements IAsteroidSplitter {
    ...
    public void createSplitAsteroid(Entity e, World world) {
        ...
        float by1 = (float) Math.sin(radians1) * e.getRadius() * asteroid1.getRadius();
        float bx1 = (float) Math.cos(radians1) * e.getRadius() * asteroid1.getRadius();
        ...
        float by2 = (float) Math.sin(radians2) * e.getRadius() * asteroid2.getRadius();
        float bx2 = (float) Math.cos(radians2) * e.getRadius() * asteroid2.getRadius();
